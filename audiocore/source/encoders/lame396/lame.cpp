...
lame_init_params(lame_global_flags * const gfp)
{
    ...
    if (NULL == gfc->VBR)
        gfc->VBR = (VBR_t *)calloc(1, sizeof(VBR_t));
    if (NULL == gfc->VBR)
        return -2;
   ...
   *******************************************************/
    ...
    gfc->ATH->aa_sensitivity_p = pow( 10.0f, (FLOAT)gfp->athaa_sensitivity / -10.0f );
                   ...
                   const int nsamples, unsigned char *mp3buf, const int mp3buf_size)
{
    ...
    in_buffer[0] = (sample_t *)calloc(sizeof(sample_t), nsamples);
    in_buffer[1] = (sample_t *)calloc(sizeof(sample_t), nsamples);
                               ...
                               unsigned char *mp3buf, int mp3buf_size)
{
    ...
    buffer_l = (sample_t *)calloc(sizeof(sample_t), nsamples);
    buffer_r = (sample_t *)calloc(sizeof(sample_t), nsamples);
